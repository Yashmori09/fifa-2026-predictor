...
const TERMS: Record<string, string> = {
  ...
  "Upset": "A finished match where the model gave one team at least a 70% chance to win, but that team failed to win, whether they lost outright or were held to a draw.",
